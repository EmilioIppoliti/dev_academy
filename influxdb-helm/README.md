...
This repository represents the official helm repository of influxdb and is therefore available for download from the [jfrog artifactory](http://134.44.28.237:30238/artifactory/helm-local) as **influxdb-helm-0.1.0-official** and derives from the [official influxdb helm chart](https://artifacthub.io/packages/helm/influxdata/influxdb/4.7.2) by [influxdata](https://www.influxdata.com/)
